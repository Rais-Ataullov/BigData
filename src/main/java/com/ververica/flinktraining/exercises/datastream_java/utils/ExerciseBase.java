...
public class ExerciseBase {
	...
	public final static String pathToRideData = "D:/RaisAtaullov/8sem/big_data/data/nycTaxiRides.gz";
	public final static String pathToFareData = "D:/RaisAtaullov/8sem/big_data/data/nycTaxiFares.gz";
